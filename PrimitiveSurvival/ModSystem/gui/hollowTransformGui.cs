...
namespace PrimitiveSurvival.ModSystem
{
    ...
    public class GuiDialogHollowTransform : GuiDialog
    {
        ...
        private void ComposeDialog()
        {
            ...
            this.SingleComposer = this.capi.Gui.CreateCompo("transformeditor", dialogBounds).AddShadedDialogBG(bgBounds).AddDialogTitleBar("Transform Editor (Tree Hollows)", this.OnTitleBarClose)
