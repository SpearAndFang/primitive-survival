...
namespace PrimitiveSurvival.ModSystem
{
    ...
    public class BehaviorFurrow : CollectibleBehavior
    {
        public BehaviorFurrow(CollectibleObject collObj) : base(collObj) { }
        ...
        public override bool OnHeldInteractStep(float secondsUsed, ItemSlot slot, EntityAgent byEntity, BlockSelection blockSel, EntitySelection entitySel, ref EnumHandling handling)
        {
            ...
            if (!block.Code.Path.StartsWith("farmland")) return false;
            ...
            if (secondsUsed > 0.6f && byEntity.Attributes.GetInt("didtill") == 0 && byEntity.World.Side == EnumAppSide.Server)
            {
                ...
                this.Till(secondsUsed, slot, byEntity, blockSel, entitySel);
            }
        ...
        private void Till(float secondsUsed, ItemSlot slot, EntityAgent byEntity, BlockSelection blockSel, EntitySelection entitySel)
        {
            if (blockSel == null)
            { return; }
            var pos = blockSel.Position;
