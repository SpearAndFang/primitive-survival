namespace PrimitiveSurvival.ModSystem
{
    ...
    public class AiTaskMeleeAttackCrab : AiTaskMeleeAttack
    {
        ...
        private new readonly float damage = 3f;
        private new readonly float minDist = 1.5f;
        private new readonly float minVerDist = 1.5f;
        private new bool damageInflicted = false;
        private new readonly int attackDurationMs = 500;
        private new readonly int damagePlayerAtMs = 300;
        ...
        public AiTaskMeleeAttackCrab(EntityAgent entity, JsonObject taskConfig, JsonObject aiConfig) : base(entity, taskConfig, aiConfig)
