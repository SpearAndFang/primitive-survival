...
#nullable disable
    ...
    public class PSToolMoldRenderer : IRenderer
    {
        BlockPos pos;
        ICoreClientAPI api;
        ...
        private readonly PSBlockEntityToolMold entity;

        internal Cuboidf[] fillQuadsByLevel;

        public ItemStack stack;

        public PSToolMoldRenderer(PSBlockEntityToolMold betm, ICoreClientAPI api, Cuboidf[] fillQuadsByLevel = null)
        {
            this.pos = betm.Pos;
            this.api = api;
            entity = betm;
