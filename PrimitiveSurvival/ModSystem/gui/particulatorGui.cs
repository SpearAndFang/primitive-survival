            ...
            if (currentTab == "C#")
            {
                ...
                if (data.particleType == "Primary")
                {
                    ...
                    if (!data.mainThread)
                    {
                        ...
                        if (data.neibSecX != -1)
                        {
                            if (this.capi.World.BlockAccessor.GetBlockEntity(new BlockPos(data.neibSecX, data.neibSecY, data.neibSecZ, 0)) is BEParticulator be)
                            {
                                neibData = be.Data;
                                if (neibData != null)
                                {
                        ...
                        {
                            if (this.capi.World.BlockAccessor.GetBlockEntity(new BlockPos(data.neibDeathX, data.neibDeathY, data.neibDeathZ, 0)) is BEParticulator be)
                            {
                                neibData = be.Data;
                                if (neibData != null)
                                {
