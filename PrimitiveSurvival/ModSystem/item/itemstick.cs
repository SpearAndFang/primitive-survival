        ...
        public override void OnHeldIdle(ItemSlot slot, EntityAgent byEntity)
        {
            ...
            if (this.canGrunt)
            {
                ...
                if (byEntity.World is IClientWorldAccessor)
                {
                    ...
                    this.TpHandTransform.Translation.X = -0.82f;
                    this.TpHandTransform.Translation.Y = -0.04f;
                    this.TpHandTransform.Translation.Z = -0.49f;
                    this.TpHandTransform.Rotation.X = 21;
                    this.TpHandTransform.Rotation.Y = 137;
                    this.TpHandTransform.Rotation.Z = 11;
                    this.TpHandTransform.Origin.X = 0.5f;
                    this.TpHandTransform.Origin.Y = 0.0f;
                    ...
                    if (chanceMultiplier > 0 && conds.Temperature > 0 && conds.Temperature < 35)
                    {
                        ...
                        if (rando < (chanceMultiplier * 10)) // max 10% chance
                        {
                            ...
                            if (entity != null)
                            {
                                ...
                                do
                                {
                                    var Pos1 = new BlockPos((int)entity.ServerPos.X, (int)entity.ServerPos.Y, (int)entity.ServerPos.Z, 0);
                                    blockSpwn = byEntity.World.BlockAccessor.GetBlock(Pos1, BlockLayersAccess.Default);
