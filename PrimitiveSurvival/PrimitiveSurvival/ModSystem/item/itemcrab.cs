    ...
    public class ItemCrab : Item
    {
        ...
        public override void OnHeldInteractStart(ItemSlot slot, EntityAgent byEntity, BlockSelection blockSel, EntitySelection entitySel, bool firstEvent, ref EnumHandHandling handHandling)
        {
            if (byEntity.Controls.Sneak && blockSel != null)
            {
                ...
                var location = new AssetLocation(this.Code.Domain, this.CodeEndWithoutParts(1));
                ...
                if (entity != null)
                {
                    ...
                    entity.ServerPos.Y = blockSel.Position.Y + (blockSel.DidOffset ? 0 : blockSel.Face.Normali.Y + 0.1f);
